...
class LLMRecurrentBlock(nn.Module):
...
class LLMRecurrentBlocks(nn.Module):
    def __init__(
...
class LLMRecurrentModel(module.LLM_ModelBase):
    def __init__(
        self,
        ...
        self.blocks = LLMRecurrentBlocks(
            n_layer=n_layer,
            head_nums=head_nums,
            head_size=head_size,
            a_embd=token_embd,
...
def train():
    ...
    train_env.setup_tensorboard(Path("/root/tf-logs/llm_recurrent"))
